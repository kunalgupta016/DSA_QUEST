...
const operations = [
  {
    category: "Traversals",
    items: [
      { name: "BFS (Breadth First Search)", path: "/graphs/operations/bfs" },
      { name: "DFS (Depth First Search)", path: "/graphs/operations/dfs" },
      { name: "Topological Sort", path: "/graphs/operations/topo-sort" },
    ],
  },
  {
    category: "Shortest Path",
    items: [
      { name: "Dijkstra's Algorithm", path: "/graphs/operations/dijkstra" },
      {
    ...
    items: [
      {
        ...
        path: "/graphs/operations/kosaraju",
      },
    ],
  },
];
