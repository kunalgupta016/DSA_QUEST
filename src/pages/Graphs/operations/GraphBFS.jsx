...
const GraphBFS = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white pt-24 px-8 pb-8 flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-8 text-yellow-500">BFS Traversal</h1>
      <div className="mb-8 text-center max-w-3xl space-y-4">
        <p className="text-gray-300">
          <strong>English:</strong> Breadth-First Search (BFS) explores all
          neighbors at the present depth prior to moving on to the nodes at the
          next depth level. It uses a Queue.
        </p>
        <p className="text-gray-400 italic">
          <strong>Hinglish:</strong> BFS pehle current depth ke sabhi neighbor
          nodes ko explore karta hai, fir agle level par move karta hai. Yeh
          Queue ka use karta hai.
        </p>
      </div>
