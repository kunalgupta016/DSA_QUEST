...
const graphSubtopics = [
  { name: "Basics", path: "/graphs/basics", color: "bg-red-500" },
  {
    name: "Graph Operations",
    path: "/graphs/operations",
    path: "/graphs/operations",
    color: "bg-yellow-500",
  },
  { name: "Challenges", path: "/graphs/challenges", color: "bg-purple-500" },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white px-4 py-10 pt-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {graphSubtopics.map((topic, index) => (
