  ...
  const levels = [
    {
      ...
      x: 10,
      y: 80,
      path: "/game/arrays/code/1",
    },
    { id: 2, title: "Index Sniper", x: 25, y: 60, path: "/game/arrays/code/2" },
    { id: 3, title: "Sliding Wall", x: 50, y: 70, path: "/game/arrays/code/3" },
    {
      id: 4,
      title: "Trash Collector",
      x: 70,
      y: 50,
      path: "/game/arrays/code/4",
    },
    { id: 5, title: "Linear Hunt", x: 80, y: 20, path: "/game/arrays/code/5" },
    {
      id: 6,
      title: "Divider Quest",
      x: 60,
      y: 10,
      path: "/game/arrays/code/6",
    },
    { id: 7, title: "The Rotator", x: 40, y: 15, path: "/game/arrays/code/7" },
    { id: 8, title: "Twin Pairs", x: 20, y: 25, path: "/game/arrays/code/8" },
    { id: 9, title: "The Leader", x: 10, y: 40, path: "/game/arrays/code/9" },
    {
      id: 10,
      title: "Boss: Kadane",
      x: 50,
      y: 50,
      path: "/game/arrays/code/10",
      isBoss: true,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0b0c15] text-white pt-20 overflow-hidden relative">
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-yellow-900/20 via-[#0b0c15] to-[#0b0c15]" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto h-[80vh] w-full mt-10 p-4 border border-gray-800 bg-black/40 rounded-3xl backdrop-blur-sm shadow-2xl relative">
        <h1 className="absolute top-6 left-6 text-3xl font-bold text-yellow-500 drop-shadow-lg flex items-center gap-3">
          👨‍💻 Array Code Quest
        </h1>
        ...
        {levels.map((level, i) => {
          const isUnlocked = level.id <= progress + 2;
          ...
          return (
            ...
            >
              <div className="relative flex flex-col items-center">
                {level.id === 1 && (
                  <div className="absolute w-16 h-16 bg-yellow-500/50 rounded-full animate-ping" />
                )}
                                        ...
                                        ${
                                          isUnlocked
                                            ? level.isBoss
                                              ...
                                              : "bg-gray-900 border-yellow-500 shadow-yellow-500/50"
                                            : "bg-gray-800 border-gray-600 grayscale opacity-50"
                                        }
                                    `}
                >
                  <span
                    className={`font-bold text-lg md:text-xl ${level.isBoss ? "text-red-400" : "text-yellow-300"}`}
                  >
                    {level.id}
                  </span>
                </motion.div>
