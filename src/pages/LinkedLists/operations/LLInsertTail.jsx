    ...
    <div className="min-h-screen bg-gray-900 text-white pt-24 px-8 pb-8 flex flex-col items-center">
      ...
      <div className="mb-8 text-center max-w-3xl space-y-4">
        <p className="text-gray-300">
          <strong>English:</strong> Inserts a new node at the very end of the
          linked list. The new node becomes the new Tail.
        </p>
        <p className="text-gray-400 italic">
          <strong>Hinglish:</strong> Linked List ke ant mein naya node insert
          karta hai. Naya node Tail ban jata hai.
        </p>
      </div>
