...
const LLDeleteHead = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white pt-24 px-8 pb-8 flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-8 text-red-500">Delete Head</h1>
      <div className="mb-8 text-center max-w-3xl space-y-4">
        <p className="text-gray-300">
          <strong>English:</strong> Removes the first node of the list. The
          second node becomes the new Head.
        </p>
        <p className="text-gray-400 italic">
          <strong>Hinglish:</strong> List ka pehla node remove karta hai. Dusra
          node naya Head ban jata hai.
        </p>
      </div>
