      ...
      <div className="max-w-4xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg border border-green-400">
        ...
        <div className="mb-8 text-center max-w-3xl mx-auto space-y-4">
          <p className="text-gray-300">
            <strong>English:</strong> Insert at End adds a new element to the
            very last position of the array. No shifting is required.
          </p>
          <p className="text-gray-400 italic">
            <strong>Hinglish:</strong> Insert at End ka matlab hai array ke
            sabse aakhri position par naya element add karna. Ye sabse simple
            insertion hota hai, isme koi shifting nahi hoti.
          </p>
        </div>
