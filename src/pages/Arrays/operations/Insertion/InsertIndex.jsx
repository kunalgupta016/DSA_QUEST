...
const InsertIndex = () => {
  ...
  const handleInsert = async () => {
    if (value === "" || index === "" || index < 0 || index > array.length)
      return;
      ...
      <div className="max-w-5xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg border border-purple-400">
        ...
        <div className="mb-8 text-center max-w-3xl mx-auto space-y-4">
          <p className="text-gray-300">
            <strong>English:</strong> Insert at Specific Index inserts a new
            element at a given position. All elements after that index are
            shifted to the right.
          </p>
          <p className="text-gray-400 italic">
            <strong>Hinglish:</strong> Insert at Index ka matlab hai array ke
            kisi particular position par naya element daalna. Pehle us index ke
            baad ke sabhi elements ko right shift karna padta hai, fir desired
            value ko uss position par insert kiya jaata hai.
          </p>
        </div>
