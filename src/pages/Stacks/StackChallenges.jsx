...
const challenges = [
  { name: "Valid Parentheses", path: "/stacks/challenges/valid-parentheses" },
  { name: "Reverse String", path: "/stacks/challenges/reverse-string" },
  { name: "Min Stack", path: "/stacks/challenges/min-stack" },
];
