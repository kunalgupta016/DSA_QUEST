...
const StackPop = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white pt-24 px-8 pb-8 flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-8 text-red-500">Operation: Pop</h1>
      <div className="mb-8 text-center max-w-3xl space-y-4">
        <p className="text-gray-300">
          <strong>English:</strong> Pop removes the element from the TOP of the
          stack. If the stack is empty, it causes a Stack Underflow.
        </p>
        <p className="text-gray-400 italic">
          <strong>Hinglish:</strong> Pop operation stack ke TOP se element
          remove karta hai. Agar stack empty hai, toh yeh Stack Underflow
          kehlata hai.
        </p>
      </div>
