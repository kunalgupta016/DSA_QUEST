...
const stackSubtopics = [
  { name: "Basics", path: "/stacks/basics", color: "bg-red-500" },
  {
    name: "Stack Operations",
    path: "/stacks/operations",
    color: "bg-blue-500",
  },
  { name: "Challenges", path: "/stacks/challenges", color: "bg-green-500" },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white px-4 py-10 pt-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {stackSubtopics.map((topic, index) => (
